(function (global, factory) {
  ...
  */
  ...
  var MarkOption = function MarkOption(options) {
    this.value = "";
    this.label = "";
  ...
  QuestionModel.prototype.resetOptions = function resetOptions () {
    ...
    if (this.options) {
      ...
      this.options.forEach(function (o) {
        ...
        if (
          this$1$1.answer === optionValue ||
          (isArray && this$1$1.answer.indexOf(optionValue) !== -1)
        ) {
          o.selected = true
          ;++numSelected;
        } else {
  ...
  QuestionModel.prototype.isMultipleChoiceType = function isMultipleChoiceType () {
    return [
      ...
      QuestionType.MultiplePictureChoice ].includes(this.type)
  };
  ...
  */
  ...
  var _hoisted_5$4 = /*#__PURE__*/require$$0.createElementVNode("span", { class: "f-arrow-down" }, [
  ...
  function render$b(_ctx, _cache, $props, $setup, $data, $options) {
    return (require$$0.openBlock(), require$$0.createElementBlock("span", _hoisted_1$9, [
      require$$0.createElementVNode("select", {
        ...
        (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(_ctx.question.options, function (option, index) {
  ...
  function render$a(_ctx, _cache, $props, $setup, $data, $options) {
    var _directive_mask = require$$0.resolveDirective("mask");
      ...
      validateMask: function validateMask() {
        ...
        if (Array.isArray(this.question.mask)) {
          return this.question.mask.some(
            function (mask) { return mask.length === this$1$1.dataValue.length; }
          );
        }
  ...
  function render$9(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_the_mask = require$$0.resolveComponent("the-mask");
      ...
      (_ctx.question.mask)
        ...
        : (require$$0.openBlock(), require$$0.createElementBlock("input", {
            ...
            onKeyup: [
              ...
              _cache[2] || (_cache[2] = require$$0.withKeys(require$$0.withModifiers(function () {
                var args = [], len = arguments.length;
                while ( len-- ) args[ len ] = arguments[ len ];

                return (_ctx.onEnter && _ctx.onEnter.apply(_ctx, args));
    }, ["prevent"]), ["enter"])),
              _cache[3] || (_cache[3] = require$$0.withKeys(require$$0.withModifiers(function () {
                var args = [], len = arguments.length;
                while ( len-- ) args[ len ] = arguments[ len ];
  ...
  function render$7(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_textarea_autosize = require$$0.resolveComponent("textarea-autosize");
      ...
      require$$0.createElementVNode("ul", {
        ...
        (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(_ctx.question.options, function (option, index) {
          return (require$$0.openBlock(), require$$0.createElementBlock("li", {
            onClick: require$$0.withModifiers(function ($event) { return ($options.toggleAnswer(option)); }, ["prevent"]),
        ...
        (!$data.hasImages && _ctx.question.allowOther)
          ? (require$$0.openBlock(), require$$0.createElementBlock("li", {
              ...
              onClick: _cache[5] || (_cache[5] = require$$0.withModifiers(function () {
                var args = [], len = arguments.length;
                while ( len-- ) args[ len ] = arguments[ len ];
  ...
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return (require$$0.openBlock(), require$$0.createElementBlock("input", {
      ...
      required: _ctx.question.required,
      onKeyup: [
        _cache[0] || (_cache[0] = require$$0.withKeys(require$$0.withModifiers(function () {
          var args = [], len = arguments.length;
          while ( len-- ) args[ len ] = arguments[ len ];

          return (_ctx.onEnter && _ctx.onEnter.apply(_ctx, args));
    }, ["prevent"]), ["enter"])),
        _cache[1] || (_cache[1] = require$$0.withKeys(require$$0.withModifiers(function () {
          var args = [], len = arguments.length;
          while ( len-- ) args[ len ] = arguments[ len ];
  ...
  var _hoisted_2$3 = /*#__PURE__*/require$$0.createElementVNode("td", null, null, -1 /* HOISTED */);
  ...
  var _hoisted_10$2 = /*#__PURE__*/require$$0.createElementVNode("span", { class: "f-field-mask f-radio-mask" }, [
    /*#__PURE__*/require$$0.createElementVNode("svg", {
      viewBox: "0 0 24 24",
  ...
  var _hoisted_14$2 = /*#__PURE__*/require$$0.createElementVNode("span", { class: "f-field-mask f-checkbox-mask" }, [
    /*#__PURE__*/require$$0.createElementVNode("svg", {
      viewBox: "0 0 24 24",
      ...
      require$$0.createElementVNode("table", {
        ...
        require$$0.createElementVNode("thead", null, [
          require$$0.createElementVNode("tr", null, [
            _hoisted_2$3,
            (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(_ctx.question.columns, function (column, index) {
        ...
        require$$0.createElementVNode("tbody", null, [
          (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList(_ctx.question.rows, function (row, index) {
  ...
  var script$3 = {
    ...
    mounted: function mounted() {
      ...
      this.$nextTick(function () {
        this$1$1.$refs.slider.$el.querySelector(".vue-slider-dot").style.left = "50%";
      });
    },
    methods: {
      focus: function focus() {
      ...
      broadcastOnChange: function broadcastOnChange(e) {
        this.onChange({ target: { value: e } });
      },
      transformMarks: function transformMarks(marks) {
        return marks.reduce(
          function (acc, mark) {
            var obj;

            return (Object.assign({}, acc, ( obj = {}, obj[("" + (mark.value))] = mark.label, obj )));
        },
          {}
        );
      },
  ...
  function render$2(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_vue_slider = require$$0.resolveComponent("vue-slider");
        ...
        ($options.showClearButton)
          ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_1$2, [
              require$$0.createElementVNode("a", {
                href: "#",
                onClick: _cache[2] || (_cache[2] = require$$0.withModifiers(function () {
                  var args = [], len = arguments.length;
                  while ( len-- ) args[ len ] = arguments[ len ];

                  return ($options.clear && $options.clear.apply($options, args));
    }, ["prevent"])),
  ...
  var _hoisted_6$1 = /*#__PURE__*/require$$0.createElementVNode("span", { "aria-hidden": "true" }, "*", -1 /* HOISTED */);
  var _hoisted_7$1 = [
    _hoisted_6$1
  ];
  var _hoisted_8$1 = {
          ...
          ($props.question.description || $props.question.descriptionLink.length !== 0)
            ? (require$$0.openBlock(), require$$0.createElementBlock("p", _hoisted_15$1, [
                ($props.question.description)
                  ...
                  : require$$0.createCommentVNode("v-if", true),
                (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($props.question.descriptionLink, function (link, index) {
          ...
          ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_18$1, [
              ...
              ($props.question.type !== $data.QuestionType.LongText || !_ctx.isMobile)
                ? (require$$0.openBlock(), require$$0.createElementBlock("a", {
                    ...
                    class: "f-enter-desc",
                    href: "#",
                    onClick: _cache[3] || (_cache[3] = require$$0.withModifiers(function () {
                      var args = [], len = arguments.length;
                      while ( len-- ) args[ len ] = arguments[ len ];
  ...
  */
                  ...
                  Object.keys(model).forEach(function (key) {
                    if (props[key] !== undefined) {
                      if (typeof model[key] === "boolean") {
                        ...
                        var classReference = classMap[key],
                          options = [];
              ...
              if (nextId === "_submit") {
                ...
                var loop$1 = function ( i ) {
                  if (this$1$1.questionModels[i].id === nextId) {
                    if (
                      i < index &&
                      questions.some(function (q) { return q === this$1$1.questionModels[i]; })
                    ) {
      ...
      goToQuestion: function goToQuestion(index) {
        ...
        if (index !== this.activeQuestionIndex) {
          ...
          if (
            ...
            do {
              var previousQuestionsAnswered = this.questionListActivePath
                .slice(0, index)
  ...
  var _hoisted_14 = /*#__PURE__*/require$$0.createElementVNode("svg", {
    version: "1.1",
    xmlns: "http://www.w3.org/2000/svg",
    "xmlns:xlink": "http://www.w3.org/1999/xlink",
    x: "0px",
  ...
  var _hoisted_17 = /*#__PURE__*/require$$0.createElementVNode("svg", {
    version: "1.1",
    xmlns: "http://www.w3.org/2000/svg",
    "xmlns:xlink": "http://www.w3.org/1999/xlink",
    x: "0px",
  ...
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_flow_form_question = require$$0.resolveComponent("flow-form-question");
    ...
    return (require$$0.openBlock(), require$$0.createElementBlock("div", {
      ...
      require$$0.createElementVNode("div", _hoisted_1, [
        require$$0.createElementVNode("div", _hoisted_2, [
          (require$$0.openBlock(true), require$$0.createElementBlock(require$$0.Fragment, null, require$$0.renderList($data.questionList, function (q, index) {
          ...
          ($options.isOnLastStep)
            ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_3, [
                require$$0.renderSlot(_ctx.$slots, "complete", {}, function () { return [
                ...
                require$$0.renderSlot(_ctx.$slots, "completeButton", {}, function () { return [
                  ...
                  (!$data.submitted)
                    ? (require$$0.openBlock(), require$$0.createElementBlock("button", {
                        ...
                        type: "button",
                        href: "#",
                        onClick: _cache[0] || (_cache[0] = require$$0.withModifiers(function ($event) { return ($options.submit()); }, ["prevent"])),
                  ...
                  (!$data.submitted)
                    ? (require$$0.openBlock(), require$$0.createElementBlock("a", {
                        ...
                        class: "f-enter-desc",
                        href: "#",
                        onClick: _cache[1] || (_cache[1] = require$$0.withModifiers(function ($event) { return ($options.submit()); }, ["prevent"])),
                        innerHTML: $props.language.formatString($props.language.pressEnter)
          ...
          ($props.navigation)
            ? (require$$0.openBlock(), require$$0.createElementBlock("div", _hoisted_12, [
                ...
                'f-disabled': $data.activeQuestionIndex === 0 || $data.submitted,
                  ...
                  href: "#",
                  onClick: _cache[2] || (_cache[2] = require$$0.withModifiers(function ($event) { return ($options.goToPreviousQuestion()); }, ["prevent"])),
                  role: "button",
                ...
                require$$0.createElementVNode("a", {
                  ...
                  href: "#",
                  onClick: _cache[3] || (_cache[3] = require$$0.withModifiers(function ($event) { return ($options.goToNextQuestion()); }, ["prevent"])),
                  role: "button",
