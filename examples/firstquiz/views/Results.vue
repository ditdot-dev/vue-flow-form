...
export default {
  ...
  computed: {
    ...Vuex.mapState('userInformation', {
      ...
      expenses: state => "$" + state.userInput.expenses.toLocaleString('en-US'),
      income: state => "$" + state.userInput.income.toLocaleString('en-US'),
      filing_state: state => state.userInput.tax_filing_state,
      medicareTax: state => "$" + state.taxUpdate.medicareTax.toLocaleString('en-US'),
      socialSecurityTax: state => "$" + state.taxUpdate.socialSecurityTax.toLocaleString('en-US'),
      selfEmploymentTax: state => "$" + state.taxUpdate.selfEmploymentTax.toLocaleString('en-US'),
      stateIncomeTax: state => "$" + state.taxUpdate.stateIncomeTax.toLocaleString('en-US'),
      federalIncomeTax: state => "$" + state.taxUpdate.federalIncomeTax.toLocaleString('en-US'),
