    ...
    <div class="row3 flex">
      ...
      <div class="slider">
        <div style="position: relative" class="up-drag">
          <h2></h2>
          <vue-slider v-model="projectedValue" :interval="10" :marks="true" :min="0" :max="getRoundofValue" height="60px" :tooltip="'none'">
      ...
      <div class="boxes relative">
        ...
        <div class="box1 boxwrapper">
          ...
          <div class="col3 col flex2 justify-content-between relative">
            ...
            <div class="colBox">
              <vue-custom-slider @handleDrag="handleIndividualDrag" v-model="sliders.individual401kPersonal" ref="sliders.individual401kPersonal" :max="sliderMax.individual401kPersonal" />
            </div>
            ...
            <div class="colBox2 colBox">
              <vue-custom-slider @handleDrag="handleIndividualDrag" v-model="sliders.individual401kBusiness" :max="sliderMax.individual401kBusiness" />
            </div>
            <p>
        ...
        <div class="box3 boxwrapper">
          ...
          <div class="col3 col flex2 justify-content-between">
            ...
            <div class="colBox">
              <vue-custom-slider v-model="sliders.simpleIraPersonal" :max="sliderMax.simpleIraPersonal" @handleDrag="handleSimpleIra" />
            </div>
            <h4>Your Business Contribution</h4>
            <info-icon tooltip="business">
              <h2>
            ...
            <div class="colBox">
              <vue-custom-slider v-model="sliders.simpleIraBusiness" :max="sliderMax.simpleIraBusiness" @handleDrag="handleSimpleIra" />
            </div>
            <p>
              At your age 67, these <br />
              contributions could be <br />
...
export default {
  ...
  methods: {
    ...
    async handleIndividualDrag() {
      ...
      this.taxAdvantageRatio.individual401k =
        Math.round(
          this.printTaxBalance.individual401k / (this.sliders.individual401kPersonal + this.sliders.individual401kBusiness) * 100)
    },
    async handleSepIraDrag() {
      ...
      this.taxAdvantageRatio.sepIra = Math.round(this.printTaxBalance.sepIra / this.sliders.sepIraBusiness * 100)
    },
    async handleSimpleIra() {
      ...
      this.taxAdvantageRatio.simpleIra =
        Math.round(
          this.printTaxBalance.simpleIra / (this.sliders.simpleIraPersonal + this.sliders.simpleIraBusiness) * 100)
    },
    async handleTraditionalIra() {
      ...
      this.taxAdvantageRatio.traditionalIra =
        Math.round(
          this.printTaxBalance.traditionalIra / this.sliders.traditionalIraPersonal * 100)
    },
  },
  computed: {
