          ...
          >
            ...
            <div class="col3 col flex2 justify-content-between relative">
              <info-icon
                ...
                <br/><br/> <strong>Your Contribution</strong> is a salary deferral and 
                reduces your taxable income.<strong>Your Business Contribution</strong> 
                is a form of employee benefits and is treated as a business expense to 
                the IRS. Thereby lowering your business’s taxable profit.<br/><br/>
                The calculator assumes you will apply your earnings through business 
                contribution, because that maximizes tax deduction opportunity.`,
                }"
  ...
  methods: {
    ...
    individual401kBusinessTooltip() {
      ...
      this.tooltip = {
        ...
        individual401kBusiness: {
          description:
            "If you pay yourself a salary (receive a W2), then this is limited to 25% of the salary you pay yourself. If you don’t pay yourself a salary, this is limited to 20% of the total earnings from your business after deducting half of self employment tax.",
          compensation,
          seTaxDeduction,
          irsLimit,
