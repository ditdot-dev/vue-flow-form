  ...
  methods: {
    ...
    individual401kBusinessTooltip() {
      this.tooltip = {
        ...this.tooltip,
        individual401kBusiness: {
          description: "This is limited to 20% of the total earnings from your business after deducting half of self employment tax.",
    ...
    handleTaxAdvantageRatioTooltip() {
      ...
      this.tooltip.taxAdvantageRatio = {
        ...this.tooltip.taxAdvantageRatio,
        individual401k: {
          description: span((this.taxAdvantageRatio.individual401k / 100).toFixed(2)),
        },
        sepIra: {
          description: span((this.taxAdvantageRatio.sepIra / 100).toFixed(2)),
        },
        simpleIra: {
          description: span((this.taxAdvantageRatio.simpleIra / 100).toFixed(2)),
        },
        traditionalIra: {
          description: span((this.taxAdvantageRatio.traditionalIra / 100).toFixed(2)),
        },
      };
    },
  },
