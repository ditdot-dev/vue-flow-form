      ...
      <div class="boxes relative">
        ...
        <div class="box1 boxwrapper">
          ...
          <div class="col3 col flex2 justify-content-between relative">
            ...
            <div class="colBox">
              <vue-custom-slider v-model="sliders.individual401kPersonal" ref="sliders.individual401kPersonal" :max="sliderMax.individual401kPersonal" />
            </div>
        ...
        <div class="box2 boxwrapper">
          ...
          <div class="col3 col flex2 mb-5 justify-content-between m-0 py-0">
            ...
            <div class="colBox">
              <vue-custom-slider v-model="sliders.sepIraBusiness" :max="sliderMax.sepIraBusiness" />
            </div>
        ...
        <div class="box3 boxwrapper">
          ...
          <div class="col3 col flex2 justify-content-between">
            ...
            <div class="colBox">
              <vue-custom-slider v-model="sliders.simpleIraPersonal" :max="sliderMax.simpleIraPersonal" />
            </div>
            <h4>Your Business Contribution</h4>
            <info-icon tooltip="business">
              <h2>
...
export default {
  ...
  mounted() {
    ...
    this.sliderMax.individual401kBusiness = businessMax_individual401k;
    this.sliderMax.sepIraBusiness = businessMax_sepIra;
    this.sliderMax.simpleIraPersonal = personalMax_simpleIra;
    this.sliderMax.simpleIraBusiness = businessMax_simpleIra;
    this.sliderMax.traditionalIraPersonal = personalMax_traditionalIra;
  },
  methods: {
    handleSignup() {
