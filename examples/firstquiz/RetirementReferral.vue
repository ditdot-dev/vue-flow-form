        ...
        new QuestionModel({
          ...
          new QuestionModel({
            ...
            options: [
              ...
              new ChoiceOption({label: 'Colorado',value: 'ca'}),
              ...
              new ChoiceOption({label: 'Illinois',value: 'in'}),
              ...
              new ChoiceOption({label: 'Maryland',value: 'ma'}),
              ...
              new ChoiceOption({label: 'Washington District of Columbia',value: 'dc'}),
